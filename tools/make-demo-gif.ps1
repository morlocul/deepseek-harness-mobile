...
$OUT = "G:\deepseek harness\android\Harness\docs"
...
Draw-Text $g "DeepSeek Harness pe telefon" 118 180 (MakeFont 16 'Regular') $MUTED
# address field
Draw-RoundRect $g 60 260 420 70 14 $SURF
Draw-Text $g "http://nume.ts.net:3080" 80 286 (MakeFont 20 'Regular') $TEXT
Draw-Text $g "Adresa DSH" 80 254 (MakeFont 12 'Regular') $MUTED
# connect button
Draw-RoundRect $g 60 360 420 70 16 $ACCENT
Draw-Text $g "Conecteaza-te" 195 384 (MakeFont 20 'Bold') ([System.Drawing.Color]::White)
Draw-Text $g "Cum ma conectez?" 200 460 (MakeFont 16 'Regular') $ACCENT
...
Draw-Text $g "CONVERSATII" 30 90 (MakeFont 13 'Bold') $MUTED
# session cards
...
foreach($t in $titles){
  ...
  Draw-Text $g "chiar acum" 52 ($y+56) (MakeFont 13 'Regular') $MUTED
  $y += 108
}
# bottom bar
Draw-RoundRect $g 0 870 540 90 0 $SURF
Draw-Text $g "Conversatii" 60 906 (MakeFont 15 'Bold') $ACCENT
Draw-Text $g "Workspace" 250 906 (MakeFont 15 'Regular') $TEXT
Draw-Text $g "Setari" 420 906 (MakeFont 15 'Regular') $TEXT
...
Draw-Text $g "Salut! Ce putem construi?" 242 156 (MakeFont 17 'Regular') ([System.Drawing.Color]::White)
# assistant bubble (left)
Draw-RoundRect $g 30 230 400 150 14 $SURF2
Draw-Text $g "Putem face un chat nativ cu" 50 252 (MakeFont 17 'Regular') $TEXT
Draw-Text $g "DeepSeek Harness peste Tailscale," 50 280 (MakeFont 17 'Regular') $TEXT
Draw-Text $g "cu markdown si code blocks." 50 308 (MakeFont 17 'Regular') $TEXT
# code block
...
Draw-Text $g "Scrie..." 50 848 (MakeFont 16 'Regular') $MUTED
...
# ---------- FRAME 4: Settings / QR ----------
$bmp = New-Bitmap; $g = [System.Drawing.Graphics]::FromImage($bmp); $g.SmoothingMode = 'AntiAlias'; Set-Bg $g
Draw-Text $g "SETARI" 30 40 (MakeFont 13 'Bold') $ACCENT
Draw-Text $g "Configurare rapida" 30 80 (MakeFont 20 'Bold') $TEXT
...
Draw-Text $g "Scaneaza cu un cititor de QR ->" 60 390 (MakeFont 14 'Regular') $MUTED
Draw-Text $g "adresa precompletata" 60 416 (MakeFont 14 'Regular') $MUTED
# theme options
Draw-Text $g "Tema" 30 480 (MakeFont 18 'Bold') $TEXT
Draw-RoundRect $g 30 520 480 66 14 $SURF
Draw-Text $g "● Automat (urmeaza sistemul)" 50 544 (MakeFont 16 'Regular') $TEXT
Draw-RoundRect $g 30 596 480 66 14 $SURF
Draw-Text $g "○ Intunecat" 50 620 (MakeFont 16 'Regular') $MUTED
